...
const I18N = {
    ru: {
        ...
        "enc.lead":      "Зашифруй текст — token и ключ сохраняются в браузере, можно расшифровать в любой момент.",

        "enc.box.title":    "Зашифровать",
        "enc.box.labelName":"Название (необязательно):",
        "enc.box.labelPh":  "например: пароль от почты",
        "enc.box.label":    "Сообщение:",
        "enc.box.ph":       "введите текст для шифрования",
        "enc.box.run":      "Зашифровать",
        "enc.box.saved":    "Сохранено в браузере — найдёшь ниже в «Мои записи»",
        "enc.box.token":    "Token ID:",
        "enc.box.key":      "Секретный ключ:",
        "enc.box.expires":  "Действует 30 дней до:",
        "enc.box.copy":     "Копировать",

        "enc.saved.title":  "Мои записи",
        "enc.saved.clear":  "Очистить всё",
        "enc.saved.hint":   "Хранятся в этом браузере. Кликни «Подставить» — данные заполнятся в форму расшифровки.",
        "enc.saved.fill":   "Подставить",
    ...
    en: {
        ...
        "enc.lead":      "Encrypt text — the token and key are saved in your browser so you can decrypt any time.",

        "enc.box.title":    "Encrypt",
        "enc.box.labelName":"Label (optional):",
        "enc.box.labelPh":  "e.g. email password",
        "enc.box.label":    "Message:",
        "enc.box.ph":       "enter text to encrypt",
        "enc.box.run":      "Encrypt",
        "enc.box.saved":    "Saved in your browser — find it below in 'My records'",
        "enc.box.token":    "Token ID:",
        "enc.box.key":      "Secret key:",
        "enc.box.expires":  "Valid 30 days until:",
        "enc.box.copy":     "Copy",

        "enc.saved.title":  "My records",
        "enc.saved.clear":  "Clear all",
        "enc.saved.hint":   "Stored in this browser. Click 'Fill in' to auto-fill the decrypt form.",
        "enc.saved.fill":   "Fill in",
